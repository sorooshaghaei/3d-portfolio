...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled software developer with expertise in JavaScript and frameworks like Vue, React, and Node.js. I specialize in building efficient, scalable, and user-friendly solutions tailored to real-world challenges. A fast learner and team player, I’m passionate about turning ideas into impactful digital experiences. Let’s create something amazing together!
      </motion.p>
